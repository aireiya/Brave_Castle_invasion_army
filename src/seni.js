...
var seni = cc.Layer.extend({
    ctor: function() {
        this._super();
        var size = cc.director.getWinSize();

        //遷移見出し
        label01 = cc.LabelTTF.create("画面遷移", "Arial", 40);
        label01.setColor(255,255,255);
        this.addChild(label01); //文字つける時はこっち*/
        label01.setPosition(size.width * 0.5,size.height * 0.9, 15);

        var drop01 = cc.Sprite.create(res.seni01_png);　
        drop01.setScale(0.5);
        drop01.setPosition(size.width * 0.5, size.height * 0.5);
